        ...
        <div class="panel admin-panel">
            ...
            <div class="padding border-bottom">
                <ul class="search" style="padding-left:10px;">
                    ...
                    <li>
                        ...
                        <input type="submit" class="button border-main icon-search" value="搜索" onclick="lookBlog()"/>
                    </li>
                    <li>
                        <input type="submit" class="button border-main icon-refresh" onclick="refreshStudent()" value="刷新"/>
                    </li>
                </ul>
            </div>
            <table class="table table-hover text-center">
                ...
                <volist name="list" id="vo">
                    ...
                    <tr>
                        <td colspan="7" style="text-align:left;padding-left:20px;"><input type="submit" class="button border-red icon-trash-o" style="padding:5px 15px;" onclick="deleteStudent()" value="删除"/> <a href="javascript:void(0)" style="padding:5px 15px; margin:0 10px;" class="button border-blue icon-edit"> 排序</a>
                    </tr>
                    <tr>
                        <td colspan="8">
                            <div class="pagelist">
